...
public class FrameTextField extends JFrame {
    ...
    private final JTextField textField2; // text field with fixed size
    private final JTextField textField3; // text field with fixed size
    ...
    private class TextFieldHandler implements ActionListener {
        ...
        public void actionPerformed(ActionEvent event) {
            ...
            else if (event.getSource() == PasswordField) string = String.format("passwordField: %s", event.getActionCommand());
